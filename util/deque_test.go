...
func TestDequeAppend(t *testing.T) {
  ...
  // Append elements in the Deque and TestAssert it does not fail
...
func TestDequeAppendWithCapacity(t *testing.T) {
  ...
  // and TestAssert it does not fail
...
func TestDequePrepend(t *testing.T) {
  ...
  // Prepend elements in the Deque and TestAssert it does not fail
  for i := 0; i < sampleSize; i++ {
    var value string = strconv.Itoa(i)
...
func TestDequePop_fulfilled_container(t *testing.T) {
  ...
  // Pop elements of the deque and TestAssert elements come out
